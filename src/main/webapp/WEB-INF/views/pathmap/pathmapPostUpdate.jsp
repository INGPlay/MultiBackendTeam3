	...
	<div class='modal fade' id='place' tabindex='-1' aria-hidden='true'>
		<div class='modal-dialog modal-dialog-scrollable modal-lg'>
			...
			<div class='modal-header'>
				<h5 class='modal-title' id='exampleModalLabel'>장소 정보 <small id="modal-sub"></small></h5>
	...
	<main class="flex-row">
		...
		<div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white" style="width: 420px;">
			...
			<div class="input-group input-group-lg">
				<!-- 뒤로 가기 -->
				<span onclick="window.location.href='/pathmap/' + ${pathId}" class="input-group-text main_color" id="inputGroup-sizing-lg">←</span>
