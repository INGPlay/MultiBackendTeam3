...
- '작성하기' 버튼을 클릭할 경우 [로그인 페이지](#5-로그인-페이지)로 이동하게 된다.
- 로그인을 했을 경우 [리뷰 게시글 작성 페이지]()로 이동하게 된다.
...
- 제목, 작성자, 장소에 대한 키워드를 검색하면 결과가 [게시글 목록](#3-1c-게시글-목록-3-1-리뷰-조회-페이지-그림-3번)에 출력된다.
...
#### 3 - 2 - b 파일 업로드 (3-1. 리뷰 작성 페이지 그림 2번)
![main](images/review/b_2.png)
- 파일을 서버에 업로드할 수 있다.

#### 3 - 2 - 작성하기 (3-1. 리뷰 작성 페이지 그림 3번)  
